...
#             return DataValidation.handle_missing_values(df)
#         except Exception as e:
#             raise NetworkSecurityException(e, sys)
...
#             # Giữ nguyên các cột không phải số
#             return dataframe
#         except Exception as e:
#             raise NetworkSecurityException(e, sys)
...
#                 raise NetworkSecurityException("Train dataframe does not contain all columns.")
#             if not self.validate_number_of_columns(test_dataframe):
#                 raise NetworkSecurityException("Test dataframe does not contain all columns.")
